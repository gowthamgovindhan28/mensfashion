...
<%@ page import="com.gowtham.service.impl.*,com.gowtham.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #00458B; color: white; padding: 5px;">
		<h2>Mens Fashions</h2>
		<h6>Fashions fade, style is eternal</h6>
		...
		<div class="container-fluid" >
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Mens Center</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="login.jsp">Login</a></li>
					<li><a href="register.jsp">Register</a></li>
					<li><a href="index.jsp">New Arrivals</a></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Category <span class="caret"></span>
					</a>
						<ul class="dropdown-menu" style="background-color:#99DDFF; ">
							<li ><a href="index.jsp?type=T-shirts"  >T-shirts</a></li>
							<li><a href="index.jsp?type=Shirts">Shirts</a></li>
							<li><a href="index.jsp?type=Jeans">Jeans</a></li>
							<li><a href="index.jsp?type=Hoodies">Hoodies</a></li>
							<li><a href="index.jsp?type=Jackets">Jackets</a></li>
							<li><a href="index.jsp?type=Blazers">Blazers</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Mens Fashions</a>
			</div>
