...
<%@ include file="loader.html"%>
	...
	<div class="container">
		<div class="row"
			style="margin-top: 5px; margin-left: 2px; margin-right: 2px; margin-bottom:200px;">
			<form action="./UpdateProductSrv" method="post"
				class="col-md-6 col-md-offset-3"
				style="border: 2px solid black; border-radius: 10px; background-color: #3FD2C7; padding:10px;">
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="Jeans"
								<%="Jeans".equalsIgnoreCase(ptype) ? "selected" : ""%>>Jeans</option>
							<option value="Hoodies"
								<%="Hoodies".equalsIgnoreCase(ptype) ? "selected" : ""%>>Hoodies</option>
							<option value="Jackets"
								<%="Jackets".equalsIgnoreCase(ptype) ? "selected" : ""%>>Jackets</option>
							<option value="Blazers"
								<%="Blazers".equalsIgnoreCase(ptype) ? "selected" : ""%>>Blazers</option>
							<option value="Some"
								<%="Some".equalsIgnoreCase(ptype) ? "selected" : ""%>>Some
				...
				<div class="row text-center">
					<div class="col-md-4" style="margin-bottom: 2px;">
						<button formaction="adminViewProduct.jsp" class="btn btn-danger" style="background-color:green;">Cancel</button>
					</div>
					<div class="col-md-4">
