package com.gowtham.service.impl;
...
import com.gowtham.beans.DemandBean;
import com.gowtham.beans.ProductBean;
import com.gowtham.service.ProductService;
import com.gowtham.utility.DBUtil;
import com.gowtham.utility.IDUtil;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM `mens-fashion`.product where lower(ptype) like ?;");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM `mens-fashion`.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ?");
			search = "%" + search + "%";
