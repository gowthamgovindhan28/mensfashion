...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:blue;'>Welcome to Mens Fashions</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thank's for singing up with Mens Fashions.<br>"
				+ "We are glad that you choose us. We invite you to check out our latest collection of Mens Fashions."
				+ "<br>We are providing upto 60% OFF on most of the Products. So please visit our site and explore the collections."
				+ "<br><br>Our Online Mens Fashions is growing in a larger amount these days and we are in high demand so we thanks all of you for "
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "MensFashions225<br><br><br>"
				+ "Have a nice day!<br>" + "" + "</body>" + "</html>";
		try {
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Mens Fashions";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Mens Fashions!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:blue;font-weight:bold;\">Mens Fashions.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Mens Fashions";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Mens Fashions!" + "      <br/><br/>"
